...
from Conet.lib.models.model import create_model, load_model
...
class BaseDetector(object):
    def __init__(self, opt):
        ...
        opt.load_model = '/home/cmic2/ros_workspace/src/drone_detection/model/model_best.pth'
    ...
    def save_attn_weights(self, output, batch):
        raise NotImplementedError
