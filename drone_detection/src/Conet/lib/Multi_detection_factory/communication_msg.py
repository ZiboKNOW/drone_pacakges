...
class communication_msg_generator:
    ...
    def get_colla_feats(self, x, shift_mats, trans_layer):
        ...
        for c_layer in trans_layer:
            ...
            #     print('drone_{}_shift_matrix_{}'.format(self.drone_id, i),cur_shift_mats[i])
            #     print('drone_{}_target_shift_mats_{}'.format(self.drone_id, i),ego_shift_mats[i])
            #     print('drone_{}_origin_shift_mats_{}'.format(self.drone_id, i),shift_mats_q[i])
    ...
    def COLLA_MESSAGE(self, x, shift_mats):
        ...
        for i, c_layer in enumerate(self.trans_layer):
            ...
            # 4. Return fused feat
            post_commu_feats = feat_fuse * 0.5 + feat_map[:,self.drone_id] * 0.5
    ...
    def communication_graph_learning(self, val_feats, confidence_maps, require_maps, num_agents , round_id = 0, thre=0.03, sigma=0):
        ...
        print('communication_mask_nodiag: ',communication_mask_nodiag.sum())
