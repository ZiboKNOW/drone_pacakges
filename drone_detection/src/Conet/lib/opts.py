...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='multiagent_det',
        ...
        self.parser.add_argument('--exp_id', default='40m_DADW_Weighted_ColorAug_Real')
        ...
        self.parser.add_argument('--demo', default='',
                                 help='path to image/ image folders/ video. '
                                      'or "webcam"')
        self.parser.add_argument('--load_model', default='/home/cmic2/ros_workspace/src/drone_detection/model/model_80.pth',
        ...
        self.parser.add_argument('--trans_layer', default=[-2], nargs='+', type=int,
                                 help='feature transform layer (range from 0 to 3), larger --> deeper')
        self.parser.add_argument('--coord', default='Global',
        ...
        self.parser.add_argument('--polygon',  type=bool, default=True,
        ...
        self.parser.add_argument('--map_scale', type=float, default=1.0,
                                 help='map scale')
        self.parser.add_argument('--warp_mode', default='DADW',
                                 help='HW or LW')
    ...
    def update_dataset_info_and_set_heads(self, opt):
        ...
        opt.feat_shape = [96, 128] if opt.real else [96, 192] # [192, 352] ### why the feat_shape should change
        opt.mean, opt.std = np.array([0.58375601, 0.54399371, 0.47015152],
                    dtype=np.float32).reshape(1, 1, 3), np.array([0.25869511, 0.24342069, 0.23500774],
    ...
    def init(self, args=''):
        default_dataset_info = {
            ...
            # 'multiagent_det': {'default_resolution': [480, 720], 'num_classes': 1,
            #           'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
            #           'dataset': 'multiagent_airsim_camera'},
